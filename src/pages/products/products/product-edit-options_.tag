...
product-edit-options-select-modal
    bs-modal
        ...
        #{'yield'}(to="body")
            catalog(object='Option', cols='{ parent.cols }', filters='{ parent.categoryFilters }', remove='{ parent.remove }', dblclick='{ parent.opts.submit.bind(this) }',
                    ...
                    .well.well-sm
                        .form-inline
                            .form-group
                                ...
                                select.form-control(data-name='idGroup', onclick='{ parent.parent.selectCategory }')
                                    option(value='') Все
                                    option(each='{ category, i in parent.parent.optionCategories }', value='{ category.id }', no-reorder) { category.name }
